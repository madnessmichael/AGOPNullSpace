...
TRAIN_VAL_DIR=data/instructions/train_val
# Configuration - Change these variables to test different models and output directories
EMBEDDING_DIR=data/embeddings/llama3.1-70b  # Output directory for embeddings
NICKNAME=llama3.1-70b
MODEL_NAME=unsloth/Meta-Llama-3.1-70B-Instruct-bnb-4bit  # Model name from HuggingFace
